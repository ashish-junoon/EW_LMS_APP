    ...
    },
    {
      ...
      cell: (row) => {
        if (row.is_e_kyc_done) {
          ...
          return (
            <span className="text-orange-500 bg-yellow-100 font-bold text-[10px] border border-yellow-500 px-2 py-0.5 rounded-full shadow-md italicl">
              Pending eKYC
            </span>
          );
        }
    ...
    <>
      ...
      <div className="mt-8">
        <Table
          ...
          filename={`Leads_Kyc_${isOnHold ? "Hold" : "UnHold"}`}
        />
      </div>
    </>
  );
